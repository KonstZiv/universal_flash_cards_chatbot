...
from piccolo.columns.column_types import (UUID, ForeignKey, Integer, Serial,
...
class ContextName(Table, tablename="context_name"):
    id = UUID(
        default=UUID4(),
        null=False,
        primary_key=True,
...
class Object(Table, tablename="object"):
    id = Serial(
        null=False,
        primary_key=True,
        unique=False,
...
class ObjectRelation(Table, tablename="object_relation"):
    id = Serial(
        null=False,
        primary_key=True,
        unique=False,
...
async def forwards():
    ...
    manager.add_table("Object", tablename="object")

    manager.add_table("ObjectRelation", tablename="object_relation")
    ...
    manager.add_table("ContextName", tablename="context_name")

    manager.add_column(
        table_class_name="Object",
        tablename="object",
        column_name="autor_id",
        db_column_name="autor_id",
    ...
    manager.add_column(
        table_class_name="Object",
        tablename="object",
        column_name="context_name_id",
        db_column_name="context_name_id",
        column_class_name="ForeignKey",
        column_class=ForeignKey,
        params={
    ...
    manager.add_column(
        table_class_name="ObjectRelation",
        tablename="object_relation",
        column_name="autor_id",
        db_column_name="autor_id",
        column_class_name="ForeignKey",
        column_class=ForeignKey,
    ...
    manager.add_column(
        table_class_name="ObjectRelation",
        tablename="object_relation",
        column_name="context_name_1",
        db_column_name="context_name_1",
        column_class_name="ForeignKey",
        column_class=ForeignKey,
        params={
            "references": Object,
    ...
    manager.add_column(
        table_class_name="ObjectRelation",
        tablename="object_relation",
        column_name="context_name_2",
        db_column_name="context_name_2",
        column_class_name="ForeignKey",
        column_class=ForeignKey,
        params={
            "references": Object,
    ...
    manager.add_column(
        table_class_name="Card",
        tablename="card",
        column_name="object_relation_id",
        db_column_name="object_relation_id",
        column_class_name="ForeignKey",
        column_class=ForeignKey,
        params={
    ...
    manager.add_column(
        table_class_name="ContextName",
        tablename="context_name",
        column_name="context_class_id",
        db_column_name="context_class_id",
        column_class_name="ForeignKey",
        column_class=ForeignKey,
        params={
